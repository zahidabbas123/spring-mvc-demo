...
<head>
	...
	<title>FLAT - Update Account-Group</title>
					...
					<div class="col-sm-12">
						<div class="box box-bordered box-color">
							...
							<div class="box-content nopadding">
								<form:form  action="UpdateAccountGroup" modelAttribute="accountGroup" method="POST" class='form-horizontal form-bordered'>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<form:select path="groupUnderID" name="groupUnderID" id="groupUnderID" class='select2-me' style="width:600px;" data-placeholder="Please select Country">
												  			<option value="0">Primary</option>
												<c:forEach var="tempAccountGroup"  items="${accountGroupList}">
													 <c:choose>
											            <c:when test="${groupUnderID == tempAccountGroup.accountGroupId}">
											                <form:option value="${tempAccountGroup.accountGroupId}" selected="true">${tempAccountGroup.accountGroupName}</form:option>
											            </c:when>
											            <c:otherwise>
											                <form:option value="${tempAccountGroup.accountGroupId}">${tempAccountGroup.accountGroupName}</form:option>
											            </c:otherwise>
											        </c:choose> 
												</c:forEach>
											   </form:select>
